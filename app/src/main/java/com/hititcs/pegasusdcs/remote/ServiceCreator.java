package com.hititcs.pegasusdcs.remote;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.hititcs.pegasusdcs.remote.interceptors.BasicAuthInterceptor;
import com.hititcs.pegasusdcs.remote.interceptors.DefaultHeaderInterceptor;
...
public class ServiceCreator {
  ...
  public ServiceCreator(String baseUrl, boolean debug, String deviceId,
    ...
    client = builder
            .addInterceptor(new BasicAuthInterceptor("HITITMW", "h*i*t*i*t*"))
            .build();
